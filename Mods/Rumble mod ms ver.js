...
var maps = [
  ...
  shipspawn: [{x:-70,y:260},{x:260,y:-70}],
  radar: {type:"box",width:7,height:7}},  
...
maps[3].basedmg = [{x:-175,x2:-230,y:-150,y2:-215},{x:175,x2:230,y:150,y2:215}];
maps[4].basedmg = [{x:-30,x2:30,y:240,y2:270},{x:-30,x2:30,y:-240,y2:-270}];
maps[5].basedmg = [{x:-210,x2:-253,y:35,y2:-35},{x:210,x2:253,y:35,y2:-35}];
maps[6].basedmg = [{x:0,x2:0,y:0,y2:0},{x:0,x2:0,y:0,y2:0}];
maps[7].basedmg = [{x:-190,x2:-235,y:30,y2:-30},{x:190,x2:235,y:30,y2:-30}];
 
let map_id = ~~(Math.random()*maps.length);
let map = maps[map_id];
let custommap = map.map, mapname = map.name, mapauthor = map.author;
//let rock; if (map_id===3) rock=10000; else if (map_id===2) rock=10000; else rock=6;
    ...
    for (let i=0; i<2; i++){
      if (teams.points[i] >= modifier.kills_to_win){
        if (!game.custom.aaaended){
          ...
          game.setOpen(false)
          for (let ship of game.ships) ship.set({type:811});
          setTimeout(function(){
            for (let ship of game.ships){
...
let map_size = 60;  
/*if (map_id === 0){
  for (let i=-map_size*5;i<map_size*5;i+=30){
  ...
  for (let i=-map_size*5;i<map_size*5;i+=20){
    addcube(map_size*5,i,4,4,4);
    addcube(-map_size*5,i,4,4,4);
  }
} else if (map_id === 2){
} //else if (map_id === 3){
...
//}
  ...
  for (let i=-map_size*5;i<map_size*5;i+=20){
    addcube(map_size*5,i,4,4,4);
    addcube(-map_size*5,i,4,4,4);
    addcube(i,map_size*5,4,4,4);
    addcube(i,-map_size*5,4,4,4);      
  }
} else if (map_id === 5){ 
  for (let i=-map_size*5;i<map_size*5;i+=10){
    addcube(map_size*5,i,2,2,2);
    addcube(-map_size*5,i,2,2,2);
  }
}*/
