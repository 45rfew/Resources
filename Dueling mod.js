...
const cow = {
  ...
  emissiveColor: hues[Math.floor(Math.random()*hues.length)]
}; 
      ...
      if (game.ships[i].custom.admin_ship === true){
        if (!ship.custom.authorized){ 
          ...
          game.ships[i].setUIComponent({ 
            ...
            shortcut: "M",
            components: [
              { type:"box",position:[0,0,200,100],fill:"rgba(68, 85, 102, 0)",stroke:"#FFFFFF",width:5},
